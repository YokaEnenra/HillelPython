...
def password_checker() -> bool:
    """Эта ф-кция првоеряет пароль пользователя и возвращает True или False в зависимости от результата проверки,
...
def automorhic_numbers():
    """Эта ф-кция выводит все автоморфные числа до указанной границы, не принимает никаких параметров и ничего не
    возвращает """
